...
Listoptions.insert(1,"Bomb the School (Joke)    ")
Listoptions.insert(2,"Crucify Jesus")


for x in range(Listoptions.size()):
    Button = ttk.Button(listboxes,text="Select",command = callback)
    Button.grid(column=2,row=x,sticky=(S, E))
    print("Added Button ",x)
